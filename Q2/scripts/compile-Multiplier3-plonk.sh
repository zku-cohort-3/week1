...
snarkjs plonk setup _plonkMultiplier3/Multiplier3.r1cs powersOfTau28_hez_final_10.ptau _Multiplier3/circuit_0000.zkey
...
snarkjs zkey export verificationkey Multiplier3/circuit_final.zkey _plonkMultiplier3/verification_key.json
